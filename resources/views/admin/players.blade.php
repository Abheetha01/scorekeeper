...
<head>
    ...
    <title>SCOREKEEPER | PLAYERS</title>
                    ...
                    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel1">EDIT PLAYER</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                <label for="emailBasic" class="form-label">TEAM</label>
                        ...
                        <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel1">ADD PLAYER</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                        ...
                        <table class="table table-dark">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    ...
                                    <td><strong>WANIDHU HASRANGA</strong></td>
                                    <td>SL</td>
                                ...
                                <tr>
                                    ...
                                    <td><strong>PATHUM NISANKA</strong></td>
                                    <td>SL</td>
                                ...
                                <tr>
                                    ...
                                    <td><strong>NUWAN KULASEKARA</strong></td>
                                    <td>SL</td>
                                    <td><span class="badge bg-success">ACTIVE</span></td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-warning btn-sm"
                                ...
                                <tr>
                                    ...
                                    <td><strong>LASITH MALINGE</strong></td>
                                    <td>SL</td>
                                    <td><span class="badge bg-success">ACTIVE</span></td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-warning btn-sm"
                                ...
                                <tr>
                                    ...
                                    <td><strong>UPUL TARANGE</strong></td>
                                    <td>SL</td>
                                    <td><span class="badge bg-success">ACTIVE</span></td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-warning btn-sm"
